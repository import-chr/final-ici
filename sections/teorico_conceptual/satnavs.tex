...
\begin{justify}
    ...
    (\DTMdisplaydate{2025}{03}{10}{}) \parencite{gpsgov}.
\end{justify}
...
\begin{justify}
    ...
    De acuerdo con \textcite{glonass_iac}, a la fecha (\DTMdisplaydate{2025}{03}{10}{}) GLONASS consta de una constelación de 24 satélites operativos en \gls{meo}, un segmento de control en tierra y equipos de usuario. La constelación GLONASS
...
\begin{justify}
    ...
    de elementos remotos y satélites \parencite{kaplan2017understanding}. Actualmente (\DTMdisplaydate{2025}{03}{10}{}) la constelación de Galileo cuenta con 27 satélites
